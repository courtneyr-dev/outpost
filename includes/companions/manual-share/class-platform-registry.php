	...
	public static function default_configs(): array {
		return array(
			array(
				...
				// F11: iOS fallback chain. F10 Android path is unchanged.
				'ios_strategy'   => array( 'navigator_share_files', 'app_url_scheme', 'manual' ),
			...
			array(
				...
				'caption_via'    => 'clipboard',
				'ios_strategy'   => array( 'navigator_share_files', 'app_url_scheme', 'manual' ),
				'app_url_scheme' => 'instagram-stories://share?source=',
