...
Not that we can confirm — Outpost is pre-release. Install it from GitHub per the [installation guide](installation.md). Its two required dependencies (IndieAuth and Micropub) are on WordPress.org.
