...
- **Post Kinds for IndieWeb** — card blocks and microformats for the kind-shaped posts the composer creates. It also reads standard.site records behind the pages you cite (a few seconds after saving, no account needed) and, with ATmosphere, decides which kinds publish as standard.site documents and how untitled ones are titled — see [How Outpost shapes a post](/outpost/how-outpost-shapes-a-post/).
